package com.example.sample_project.models; 
 
...
 
@Entity 
@Table(name = "LoanUserCollection") 
public class LoanUserCollection { 
    @Id 
    @Column(name = "loan_id") 
...
 
    @Column(name = "user_pan_card", length = 10, nullable = false) 
...
 
    @Column(name = "loan_display_status", nullable = false) 
    private String loanDisplayStatus; 
 
...
 
    // Getters and Setters 
    public String getLoanDisplayStatus() { 
        return loanDisplayStatus; 
    } 
 
    public void setLoanDisplayStatus(String loanDisplayStatus) { 
        this.loanDisplayStatus = loanDisplayStatus; 
    } 
 
